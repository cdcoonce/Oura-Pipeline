...
class TestGenerateDailyScoresChart:
    ...
    def test_returns_valid_base64_png(self, wellness_df) -> None:
    ...
    def test_handles_null_scores(self) -> None:
...
class TestGenerateSleepStagesChart:
    ...
    def test_returns_valid_base64_png(self, sleep_df) -> None:
        """Should produce valid PNG."""
    ...
    def test_filters_to_long_sleep(self) -> None:
    ...
    def test_returns_none_for_no_long_sleep(self) -> None:
...
class TestGenerateHrvTrendChart:
    ...
    def test_returns_none_for_single_record(self) -> None:
...
class TestGenerateAllCharts:
    ...
    def test_returns_all_four_keys(self, wellness_df, sleep_df) -> None:
    ...
    def test_all_charts_are_valid_or_none(self, wellness_df, sleep_df) -> None:
    ...
    def test_individual_failure_does_not_crash_others(self) -> None:
