...
class TestComputeMetricSummaries:
    ...
    def test_returns_summary_for_each_metric(self, wellness_df) -> None:
        """Should return one MetricSummary per metric in WELLNESS_METRICS."""
        result = compute_metric_summaries(
            wellness_df, date(2025, 1, 1), date(2025, 1, 30)
        )
    ...
    def test_declining_trend_detected(self, wellness_df) -> None:
    ...
    def test_stable_trend_for_flat_data(self) -> None:
    ...
    def test_days_with_data_tracks_nulls(self, wellness_df) -> None:
    ...
    def test_single_day_returns_stable_trend(self) -> None:
        ...
        assert len(result) > 0, (
            "Single-day data should produce at least one metric summary"
        )
    ...
    def test_min_max_values(self, wellness_df) -> None:
...
class TestFindPersonalBests:
    ...
    def test_finds_max_steps(self, wellness_df, sleep_df) -> None:
    ...
    def test_finds_max_sleep_score(self, wellness_df, sleep_df) -> None:
    ...
    def test_finds_max_hrv_from_long_sleep_only(self, wellness_df, sleep_df) -> None:
    ...
    def test_finds_lowest_hr(self, wellness_df, sleep_df) -> None:
    ...
    def test_results_sorted_by_metric_name(self, wellness_df, sleep_df) -> None:
    ...
    def test_empty_dfs_return_empty_list(self) -> None:
        """No data -> no personal bests."""
        empty_w = pl.DataFrame(
            schema={
                "day": pl.Date,
...
class TestIdentifyAreasToImprove:
    ...
    def test_below_threshold_triggers_alert(self, wellness_df, sleep_df) -> None:
    ...
    def test_declining_trend_triggers_alert(self, wellness_df, sleep_df) -> None:
    ...
    def test_no_alerts_for_healthy_data(self) -> None:
    ...
    def test_threshold_takes_precedence_over_decline(self) -> None:
    ...
    def test_suggestions_present(self, wellness_df, sleep_df) -> None:
...
class TestBuildSleepSummary:
    ...
    def test_filters_to_long_sleep_only(self, sleep_df) -> None:
    ...
    def test_stage_percentages_sum_to_approximately_100(self, sleep_df) -> None:
    ...
    def test_duration_in_hours(self, sleep_df) -> None:
    ...
    def test_returns_none_for_empty_df(self) -> None:
        ...
        df = pl.DataFrame(
            schema={
                "sleep_type": pl.Utf8,
                "total_sleep_duration": pl.Int64,
                "deep_sleep_duration": pl.Int64,
                "light_sleep_duration": pl.Int64,
                "rem_sleep_duration": pl.Int64,
                "awake_time": pl.Int64,
                "time_in_bed": pl.Int64,
                "efficiency": pl.Int64,
                "avg_hrv": pl.Float64,
                "avg_hr": pl.Float64,
            }
    ...
    def test_returns_none_when_no_long_sleep(self) -> None:
...
class TestBuildWorkoutSummary:
    ...
    def test_counts_by_activity(self, workout_df) -> None:
    ...
    def test_total_count_matches_rows(self, workout_df) -> None:
        """Total count should equal number of workout rows."""
        result = build_workout_summary(workout_df)
        assert result is not None
        assert result.total_count == 15

    def test_total_calories(self, workout_df) -> None:
...
class TestBuildReportData:
    ...
    def test_builds_complete_report(self, wellness_df, sleep_df, workout_df) -> None:
    ...
    def test_report_dates_match(self, wellness_df, sleep_df, workout_df) -> None:
    ...
    def test_personal_bests_present(self, wellness_df, sleep_df, workout_df) -> None:
    ...
    def test_frozen_dataclass(self, wellness_df, sleep_df, workout_df) -> None:
